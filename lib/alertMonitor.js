...
export async function runPollCycle() {
  ...
  const [failures, stuck, reconcile] = await Promise.allSettled([
  ...
  if (reconcile.status === "rejected") {
    console.error("[alert-monitor] stuck document reconcile failed:", reconcile.reason?.message || reconcile.reason);
  }
}
