 ...
 * @param {object} filters - { search, clientEmails[], docType, issueType, bugStatus, clientId, page, pageSize }
 */
export async function getBugTrackerRows(filters = {}) {
  const { search = "", clientEmails = [], docType = "", issueType = "", bugStatus = "", clientId = "", sortBy = "", sortOrder = "desc", page = 1, pageSize = 50 } = filters;
...
export async function getBugTrackerRowsForExport(filters = {}) {
  const { search = "", clientEmails = [], docType = "", issueType = "", bugStatus = "", clientId = "", sortBy = "", sortOrder = "desc", limit = EXPORT_ROW_CAP } = filters;
