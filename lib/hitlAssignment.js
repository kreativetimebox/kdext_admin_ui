...
// Active HITL members and how many not-yet-completed rows are already
// assigned to each. Raw d.hitl_status (not the derived expression above) is
// reliable here because every assigned row explicitly carries 'PENDING'
// until commitReprocessedResult sets it to 'COMPLETED'.
