...
export const ACTION_STATUSES = [
  "Model Tuning",
  "Reprocessing",
  "Invalid Bad Image Closed",
];

// Roles assignable to internal (team) users. Mirrors ALLOWED_ROLES in
// middleware.js — these are the only roles that can log into this app.
export const TEAM_ROLES = ["SUPER_ADMIN", "ADMIN", "HITL", "SERVER_MONITOR"];
