...
export async function getDocumentsWithMissingFields(filters = {}) {
  const { search = "", docType = "", showAll = false, clientId = "", businessName = "", status = "", keyEnvironment = "", bugStatus = "", issueType = "", page = 1, pageSize = 50 } = filters;
...
export async function getDocumentsWithMissingFieldsForExport(filters = {}) {
  const { search = "", docType = "", showAll = true, clientId = "", businessName = "", status = "", keyEnvironment = "", bugStatus = "", issueType = "" } = filters;
