...
export async function updateBugTracking(resultId, { issueType, issueDescription, bugStatus } = {}) {
  ...
  if (issueType !== undefined) {
    ...
    setClauses.push(`issue_type = $${itIdx}`);
    ...
    setClauses.push(`bug_tracker_id = COALESCE(bug_tracker_id, CASE WHEN issue_type IS NULL AND $${itIdx} IS NOT NULL THEN nextval('bug_tracker_id_seq') END)`);
  }
